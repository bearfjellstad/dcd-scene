...
export default class ManualMSAARenderPass extends Pass {
  constructor(scene, camera, clearColor, clearAlpha) {
    ...
    //
    // Sample patterns reference: https://msdn.microsoft.com/en-us/library/globals/desktop/ff476218%28v=vs.85%29.aspx?f=255&MSPPError=-2147217396
    this.JitterVectors = [
      [[0, 0]],
      [[4, 4], [-4, -4]],
      [[-2, -6], [6, -2], [-6, 2], [2, 6]],
  ...
  render(renderer, writeBuffer, readBuffer, delta, maskActive) {
    ...
    const jitterOffsets = this.JitterVectors[
    ...
    let width = readBuffer.width;
    let height = readBuffer.height;
