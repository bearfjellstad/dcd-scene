...
export default class SAOPass extends Pass {
  constructor(scene, camera, depthTexture, useNormals, resolution) {
    ...
    this.supportsDepthTextureExtension =
      typeof depthTexture !== 'undefined' ? depthTexture : false;
    this.supportsNormalTexture =
      typeof useNormals !== 'undefined' ? useNormals : false;
    ...
    if (this.supportsDepthTextureExtension) {
      ...
      dt.maxFilter = NearestFilter;

      this.beautyRenderTarget.depthTexture = dt;
    ...
    this.saoMaterial.defines['PERSPECTIVE_CAMERA'] = this.camera
      ...
      ? 1
      : 0;
    this.saoMaterial.uniforms['tDepth'].value = this
      .supportsDepthTextureExtension
      ? depthTexture
  ...
  renderOverride(
    ...
    const clearNeeded = clearColor !== undefined && clearColor !== null;
